...
public class Day12 implements DayInterface {
    ...
    public void part2() throws Exception {
        ...
        // sur 1000000 générations on essaye de voir si il y a un pattern, un coefficient multiplicateur par age
        for (int age = 0; age < 1000000; age++) {
            ...
            System.out.println("Coefficient : " + (double) totalPots / age);
        }

        // ça tend vers 55 mais on ne peut pas trouver de coefficient
    }
}
